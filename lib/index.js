...
var ReactFlagsSelect = function (_Component) {
	...
	ReactFlagsSelect.prototype.toggleOptions = function toggleOptions(bol) {
	...
	ReactFlagsSelect.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ ref: 'selectedFlag', style: { fontSize: selectedSize + 'px' }, className: 'selected--flag--option ' + (this.props.disabled ? 'no--focus' : ''), tabIndex: this.props.tabIndex, onFocus: function onFocus() {
						return _this4.toggleOptions(true);
					}, onClick: this.toggleOptions, onKeyUp: function onKeyUp(evt) {
